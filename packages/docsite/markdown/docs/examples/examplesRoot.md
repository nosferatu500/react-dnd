...
- `?debug` - Enables **debug mode** of `@nosferatu500/dnd-core`. This registers `@nosferatu500/dnd-core` with the [Redux Devtools Chrome extension](https://github.com/zalmoxisus/redux-devtools-extension).
- `?touch` - Swaps out the backend used in the examples from `@nosferatu500/react-dnd-html5-backend` to the `@nosferatu500/react-dnd-touch-backend`.
